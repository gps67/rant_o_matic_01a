...
# fortunately the data has 365 normalised days in each year

# in 2018 search for 2017 in the filename below
...
#	P_9 = 0 # pencil lines
 ...
 function process_gnuplot_file( zoomed_out )
 {
	...
	copy_png_to_FTP = "cp -p " filename_plot_zoomed_png  " $HOME/FTP_/ "
...
function gen_pencil_data() {
	...
	print "2030 0" > filename_plot_data_pencil
	print "" > filename_plot_data_pencil

	print "1970 29.0" > filename_plot_data_pencil
